...
import Merchants from "../../../components/MerchantStaff/MerchantStaff";
import MerchantEngineer from "../../../components/MerchantEngineer/MerchantStaff";
  ...
  return (
    <DashboardLayout>
      ...
      <div className={styles.TitleContainer}>
        <h1 className={styles.Title}>Merchant Support</h1>
      </div>
      ...
      {currentTab === 1 && <Merchants />}
      {currentTab === 2 && <MerchantEngineer />}
    </DashboardLayout>
  );
};
